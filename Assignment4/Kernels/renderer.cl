...
__kernel void BushRemove(__global uint* pixels, __global int2* lastPos,  __global uint* backupBuffer, __global bool* lastTarget, __global uint* spriteTypeIndexBuffer, int spriteFrameSize)
{   
    //x = spriteFrameSize * spriteFrameSize
    //y = total tanks
...
__kernel void BushBackup(__global uint* pixels, __global float2* pos, __global uint* backupBuffer, __global bool* lastTarget, __global uint* spriteTypeIndexBuffer, int spriteFrameSize)
{
    //x = spriteFrameSize * spriteFrameSize
    //y = total tanks
...
__kernel void BushSaveLastPos( __global float2* pos, __global int2* lastPos, __global bool* lastTarget, __global uint* sprite, __global uint* spriteFrameSizes)
{
    //x = totalTanks;
...
__kernel void BushDraw(__global uint* pixels, __global uint* spritePixels, __global uint* sprite, __global float2* pos, __global int* frame, __global uint* spriteFrameSizes, __global uint* spriteOffset, int spriteFrameCount)
{
    //x = (spriteFrameSize - 1) * (spriteFrameSize - 1)
    //y = totalTanks
