...
__kernel void Draw(__global uint* pixels, __global __read_only uint* spritePixels, __global __read_only float2* pos, __constant __read_only int* frame, int spriteFrameSize, __constant __read_only int* frameCounter)
{
    ...
    int src = final_frame * spriteFrameSize + v * stride + u + offset;
